import{u as qe,a as l,A as z,j as e,R as Me}from"./index-Bj2HG1n2.js";const Te=()=>{var F,Y,W,K,J,X,G,Q,Z,ee,se,te,ae,ie,ne,re,le,oe,de,ce,me,he,xe;const{user:d,token:m}=qe(),[b,q]=l.useState(null),[w,M]=l.useState(""),[Le,Re]=l.useState(!1),[f,pe]=l.useState(!1),[A,$]=l.useState(!1),[ge,B]=l.useState(!1),[i,I]=l.useState(null),[be,L]=l.useState([]),[Ce,_]=l.useState([]),[Ae,D]=l.useState(!1),[$e,fe]=l.useState(1),[Be,je]=l.useState(0),[Ie,ve]=l.useState(1),[v,y]=l.useState([]),[T,E]=l.useState(!1),[H,Ne]=l.useState(1),[_e,we]=l.useState(0),[ye,ke]=l.useState(1),[P,R]=l.useState({});l.useRef(null),l.useEffect(()=>{const s=()=>{pe(window.innerWidth<=768)};return s(),window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[]),l.useEffect(()=>{d!=null&&d._id&&m&&typeof d._id=="string"?(Se(1),V(1)):(y([]),R({}),q(null))},[d==null?void 0:d._id,m]);const Se=async(s=1)=>{D(!0);try{const n=await fetch(`${z}/requests/owner/${d._id}?page=${s}&limit=10`,{headers:{Authorization:`Bearer ${m}`}});if(n.ok){const o=await n.json();Array.isArray(o.requests)?(L(s===1?o.requests.map(a=>{var r,h,x,u,p,g;return{id:String(a._id||""),bookId:String(((r=a.book)==null?void 0:r._id)||""),bookTitle:String(((h=a.book)==null?void 0:h.title)||"Unknown Book"),bookCover:String(((u=(x=a.book)==null?void 0:x.images)==null?void 0:u[0])||"/placeholder-book.jpg"),requesterName:String(((p=a.requester)==null?void 0:p.username)||"Unknown"),requesterId:String(((g=a.requester)==null?void 0:g._id)||""),message:String(a.message||""),status:String(a.status||"pending"),createdAt:a.createdAt,type:"incoming"}}):[...be,...o.requests.map(a=>{var r,h,x,u,p,g;return{id:String(a._id||""),bookId:String(((r=a.book)==null?void 0:r._id)||""),bookTitle:String(((h=a.book)==null?void 0:h.title)||"Unknown Book"),bookCover:String(((u=(x=a.book)==null?void 0:x.images)==null?void 0:u[0])||"/placeholder-book.jpg"),requesterName:String(((p=a.requester)==null?void 0:p.username)||"Unknown"),requesterId:String(((g=a.requester)==null?void 0:g._id)||""),message:String(a.message||""),status:String(a.status||"pending"),createdAt:a.createdAt,type:"incoming"}})]),je(o.total||0),ve(o.pages||1),fe(o.page||1)):L([])}const c=await fetch(`${z}/requests/user/${d._id}`,{headers:{Authorization:`Bearer ${m}`}});if(c.ok){const o=await c.json(),a=Array.isArray(o)?o:o.requests||[];Array.isArray(a)?_(a.map(r=>{var h,x,u,p,g,ue;return{id:String(r._id||""),bookId:String(((h=r.book)==null?void 0:h._id)||""),bookTitle:String(((x=r.book)==null?void 0:x.title)||"Unknown Book"),bookCover:String(((p=(u=r.book)==null?void 0:u.images)==null?void 0:p[0])||"/placeholder-book.jpg"),ownerName:String(((g=r.owner)==null?void 0:g.username)||"Unknown"),ownerId:String(((ue=r.owner)==null?void 0:ue._id)||""),message:String(r.message||""),status:String(r.status||"pending"),createdAt:r.createdAt,type:"outgoing"}})):_([])}}catch(n){console.error("Error fetching requests:",n)}finally{D(!1)}},V=async(s=1)=>{E(!0);try{const n=await fetch(`${z}/requests/conversations/${d._id}?page=${s}&limit=10`,{headers:{Authorization:`Bearer ${m}`}});if(n.ok){const c=await n.json();if(Array.isArray(c.conversations)){y(s===1?c.conversations.map(a=>({id:a.id,name:a.participant.username,message:a.lastMessage,time:C(a.lastMessageTime),status:a.status,avatar:`https://i.pravatar.cc/150?u=${a.participant.email}`,unread:a.unreadCount,book:a.book,requestId:a.requestId,isOwner:a.isOwner,participantId:a.id})):[...v,...c.conversations.map(a=>({id:a.id,name:a.participant.username,message:a.lastMessage,time:C(a.lastMessageTime),status:a.status,avatar:`https://i.pravatar.cc/150?u=${a.participant.email}`,unread:a.unreadCount,book:a.book,requestId:a.requestId,isOwner:a.isOwner,participantId:a.id}))]),we(c.total||0),ke(c.pages||1),Ne(c.page||1);const o={};c.conversations.forEach(a=>{o[a.id]=[{id:1,sender:a.isOwner?"other":"me",text:a.lastMessage,time:C(a.lastMessageTime)}]}),R(o),!b&&c.conversations.length>0&&q(c.conversations[0].id)}else y([])}}catch(n){console.error("Error fetching conversations:",n)}finally{E(!1)}},C=s=>{const n=new Date(s),o=new Date-n,a=Math.floor(o/(1e3*60*60*24));return a===0?n.toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit",hour12:!0}):a===1?"Yesterday":a<7?`${a} days ago`:n.toLocaleDateString("en-US",{month:"short",day:"numeric"})},j=async(s,n,c)=>{if(!s||!n||!m){console.error("Missing required parameters for request action"),alert("Unable to process request. Please try again.");return}try{if(!(await fetch(`${z}/requests/${s}`,{method:"PATCH",headers:{"Content-Type":"application/json",Authorization:`Bearer ${m}`},body:JSON.stringify({status:n})})).ok)throw new Error("Failed to update request");L(a=>a.map(r=>r.id===s?{...r,status:n}:r)),y(a=>a.map(r=>r.requestId===s?{...r,status:n}:r)),alert(`Request has been ${n} successfully!`)}catch(o){console.error("Error updating request:",o),alert(`Failed to update request: ${o.message}`)}},k=()=>{if(w.trim()){const s={id:Date.now(),sender:"me",text:w,time:new Date().toLocaleTimeString("en-US",{hour:"numeric",minute:"2-digit"})};R(n=>({...n,[b]:[...n[b]||[],s]})),M("")}},ze=s=>{q(s),f&&$(!0)},O=()=>{$(!1)},U=s=>({pending:e.jsx("span",{className:"badge bg-warning text-dark",children:"Pending"}),accepted:e.jsx("span",{className:"badge bg-success",children:"Accepted"}),rejected:e.jsx("span",{className:"badge bg-danger",children:"Rejected"})})[s]||null,S=s=>{I(s),B(!0)},N=()=>{B(!1),I(null)};if(!d||!m)return e.jsx("div",{className:"d-flex justify-content-center align-items-center",style:{height:"100vh"},children:e.jsxs("div",{className:"text-center",children:[e.jsx("h5",{children:"Please log in to access your inbox"}),e.jsx("p",{className:"text-muted",children:"You need to be logged in to see your conversations."})]})});const t=v.find(s=>s.id===b)||v[0];return T?e.jsx("div",{className:"d-flex justify-content-center align-items-center",style:{height:"100vh"},children:e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"spinner-border text-primary",role:"status",children:e.jsx("span",{className:"visually-hidden",children:"Loading..."})}),e.jsx("p",{className:"mt-2",children:"Loading conversations..."})]})}):!T&&v.length===0?e.jsx("div",{className:"d-flex justify-content-center align-items-center",style:{height:"100vh"},children:e.jsxs("div",{className:"text-center",children:[e.jsx("h5",{children:"No conversations yet"}),e.jsx("p",{className:"text-muted",children:"Start exchanging books to see your conversations here!"})]})}):t?e.jsxs(Me.Fragment,{children:[e.jsx("link",{href:"https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.0/css/bootstrap.min.css",rel:"stylesheet"}),e.jsx("style",{children:`
        .app-container {
          min-height: 100vh;
